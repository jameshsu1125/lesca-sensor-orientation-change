...
var error = function error() {
  console.log('[lesca-sensor-orientation-change]: desktop not support');
};

var call = function call() {
  var angle = window.orientation ? screen.orientation.angle : window.orientation;
  property.callback(angle !== null && angle !== void 0 ? angle : false);
};
